...
public class Background_POST extends AsyncTask<Void, Void, Void> {
    ...
    public Background_POST(TextView tvResult, String strWidth, String strLength, Context context) {
